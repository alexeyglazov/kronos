 ...
 * @author glazov
 */
public class OutOfOfficeReportForm {
    ...
    public static OutOfOfficeReportForm getFromJson(String json) {
        Gson gson = new Gson();
        return gson.fromJson(json, OutOfOfficeReportForm.class);
    }
}
