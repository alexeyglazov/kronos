 ...
 * @author glazov
 */
public class MailoutTemplateEditForm {
    ...
    private MailoutTemplateEditForm.Mode mode;
    private Long id;
    private String name;
    private String description;
    private MailoutContent mailoutContent;

    public MailoutTemplateEditForm() {
    }
    ...
    public MailoutTemplateEditForm.Mode getMode() {
        return mode;
    }

    public void setMode(MailoutTemplateEditForm.Mode mode) {
        this.mode = mode;
    }
    ...
    public static MailoutTemplateEditForm getFromJson(String json) {
        Gson gson = new Gson();
        return gson.fromJson(json, MailoutTemplateEditForm.class);
    }
