...
public class MarginReportForm {
    ...
    public static MarginReportForm getFromJson(String json) {
        Gson gson = new Gson();
        return gson.fromJson(json, MarginReportForm.class);
    }
}
