...
public class MarginReportVO {
    public class Row {
        ...
        public Row(ProfitabilityReport.Row row) {
            ...
            if(row.getStandardSellingRate() != null) {
                ...
                Currency currency = row.getStandardSellingRate().getStandardSellingRateGroup().getCurrency();
            ...
            if(row.getStandardCost() != null) {
                ...
                Currency currency = row.getStandardCost().getStandardCostGroup().getCurrency();
    ...
    public MarginReportVO(ProfitabilityReport profitabilityReport) {
        ...
        for(ProfitabilityReport.Row row : profitabilityReport.getRows()) {
            this.rows.add(new MarginReportVO.Row(row));
        }
