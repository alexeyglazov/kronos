...
pageProperties.put("title", "My stats");
pageProperties.put("description", "Page is used to get user statistics");
pageProperties.put("keywords", "Timesheet, employee, time, tasks, projects");

List<String> jsFiles = new LinkedList<String>();
jsFiles.add("main.js");
jsFiles.add("MyStatsManager.js");
...
request.setAttribute("initializer", "initMyStatsManager");
