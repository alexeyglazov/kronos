...
bodies.put("main", "/bodies/en/extract_my_time_sheet/index.jsp");

Map<String, String> pageProperties = new HashMap<String, String>();
pageProperties.put("title", "Extract my timesheet");
pageProperties.put("description", "Page is used to work with timesheets");
