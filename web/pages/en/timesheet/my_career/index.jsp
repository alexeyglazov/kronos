...
pageProperties.put("title", "My career");
pageProperties.put("description", "Page is used to see personal career");
pageProperties.put("keywords", "Career, position, leaves");

List<String> jsFiles = new LinkedList<String>();
jsFiles.add("main.js");
jsFiles.add("MyCareerViewer.js");
...
request.setAttribute("initializer", "initMyCareerViewer");
