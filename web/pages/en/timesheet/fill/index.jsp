...
pageProperties.put("title", "Timesheets");
pageProperties.put("description", "Page is used to fill in employees timesheet");
pageProperties.put("keywords", "Timesheet, employee, time, tasks, projects");

List<String> jsFiles = new LinkedList<String>();
jsFiles.add("main.js");
jsFiles.add("TimeSheet.js");
jsFiles.add("StandardTimeSheet.js");
jsFiles.add("TimeSpentItemsForm.js");
jsFiles.add("BusinessTripItemsForm.js");
...
request.setAttribute("initializer", "initTimeSheet");
