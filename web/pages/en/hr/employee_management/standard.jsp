...
pageProperties.put("title", "Employee management");
pageProperties.put("description", "Page is used for employee management");
pageProperties.put("keywords", "Employee management, employee, time, tasks, projects");

List<String> jsFiles = new LinkedList<String>();
jsFiles.add("main.js");
jsFiles.add("EmployeeManager.js");
...
request.setAttribute("initializer", "initEmployeeManager");
