...
pageProperties.put("title", "Holidays");
pageProperties.put("description", "Page is used to set Holidays");
pageProperties.put("keywords", "Holidays");

List<String> jsFiles = new LinkedList<String>();
jsFiles.add("main.js");
jsFiles.add("DataGrid.js");
jsFiles.add("HolidaysLayout.js");
jsFiles.add("HolidaysManager.js");
jsFiles.add("FreedaysManager.js");
jsFiles.add("Calendar.js");
...
request.setAttribute("initializer", "initHolidaysLayout");
