...
pageProperties.put("title", "Annual paid leaves");
pageProperties.put("description", "Page is used assign annual paid leaves");
pageProperties.put("keywords", "Position, annual paid leaves");

List<String> jsFiles = new LinkedList<String>();
jsFiles.add("main.js");
jsFiles.add("AnnualPaidLeavesManager.js");
jsFiles.add("AnnualPaidLeaveEditForm.js");
...
request.setAttribute("initializer", "initAnnualPaidLeavesManager");
