...
pageProperties.put("title", "Leaves Report");
pageProperties.put("description", "Page is used to build Leaves Report");
pageProperties.put("keywords", "Leaves, employee, time, tasks, projects");

List<String> jsFiles = new LinkedList<String>();
jsFiles.add("LeavesReport.js");
jsFiles.add("main.js");
...
request.setAttribute("initializer", "initLeavesReport");
