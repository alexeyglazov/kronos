...
pageProperties.put("title", "Business trip report");
pageProperties.put("description", "Page is used to build Business trip report");
pageProperties.put("keywords", "Timesheet, employee, time, business trip, projects");

List<String> jsFiles = new LinkedList<String>();
jsFiles.add("BusinessTripReport.js");
jsFiles.add("main.js");
...
request.setAttribute("initializer", "initBusinessTripReport");
