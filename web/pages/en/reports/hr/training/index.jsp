...
pageProperties.put("title", "Training Report");
pageProperties.put("description", "Page is used to build Training Report");
pageProperties.put("keywords", "Timesheet, employee, time, tasks, projects");

List<String> jsFiles = new LinkedList<String>();
jsFiles.add("TrainingReport.js");
jsFiles.add("main.js");
...
request.setAttribute("initializer", "initTrainingReport");
