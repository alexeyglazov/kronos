...
pageProperties.put("title", "HR Administrative Report");
pageProperties.put("description", "Page is used to build HR Administrative Report");
pageProperties.put("keywords", "HR, employee, time, tasks, projects");

List<String> jsFiles = new LinkedList<String>();
jsFiles.add("HRAdministrativeReport.js");
jsFiles.add("main.js");
...
request.setAttribute("initializer", "initHRAdministrativeReport");
