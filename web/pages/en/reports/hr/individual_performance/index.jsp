...
pageProperties.put("title", "Individual performance report");
pageProperties.put("description", "Page is used to build Individual performance report");
pageProperties.put("keywords", "Timesheet, employee, time, tasks, projects");

List<String> jsFiles = new LinkedList<String>();
jsFiles.add("IndividualPerformanceReport.js");
jsFiles.add("main.js");
...
request.setAttribute("initializer", "initIndividualPerformanceReport");
