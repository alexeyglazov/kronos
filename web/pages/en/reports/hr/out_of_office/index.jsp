...
pageProperties.put("title", "Out of office report");
pageProperties.put("description", "Page is used to build Out of office report");
pageProperties.put("keywords", "Timesheet, employee, time, business trip, projects ,leaves");

List<String> jsFiles = new LinkedList<String>();
jsFiles.add("OutOfOfficeReport.js");
jsFiles.add("main.js");
...
request.setAttribute("initializer", "initOutOfOfficeReport");
