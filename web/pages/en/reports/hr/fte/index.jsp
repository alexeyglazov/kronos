...
pageProperties.put("title", "FTE Report");
pageProperties.put("description", "Page is used to build FTE Report");
pageProperties.put("keywords", "Timesheet, employee, time, tasks, projects");

List<String> jsFiles = new LinkedList<String>();
jsFiles.add("FTEReport.js");
jsFiles.add("main.js");
...
request.setAttribute("initializer", "initFTEReport");
