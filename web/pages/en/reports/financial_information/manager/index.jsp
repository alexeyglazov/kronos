...
pageProperties.put("title", "Synthesis Report");
pageProperties.put("description", "Page is used to build Synthesis Report");
pageProperties.put("keywords", "Timesheet, employee, time, tasks, projects");

List<String> jsFiles = new LinkedList<String>();
jsFiles.add("ManagerReport.js");
jsFiles.add("main.js");
...
request.setAttribute("initializer", "initManagerReport");
