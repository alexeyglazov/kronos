...
pageProperties.put("title", "Productivity Report");
pageProperties.put("description", "Page is used to build Productivity Report");
pageProperties.put("keywords", "Financial info, employee, time, tasks, projects");

List<String> jsFiles = new LinkedList<String>();
jsFiles.add("ProductivityReport.js");
jsFiles.add("main.js");
...
request.setAttribute("initializer", "initProductivityReport");
