...
pageProperties.put("title", "Client activity report");
pageProperties.put("description", "Page is used to build Client activity report");
pageProperties.put("keywords", "Client, project code, tasks, projects");

List<String> jsFiles = new LinkedList<String>();
jsFiles.add("main.js");
jsFiles.add("ClientActivityReport.js");
...
request.setAttribute("initializer", "initClientActivityReport");
