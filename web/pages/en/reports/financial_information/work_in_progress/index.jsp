...
pageProperties.put("title", "Work in progress");
pageProperties.put("description", "Page is used to build Work in Progress report");
pageProperties.put("keywords", "Work in progress, employee, time, tasks, projects");

List<String> jsFiles = new LinkedList<String>();
jsFiles.add("WorkInProgressReport.js");
jsFiles.add("main.js");
jsFiles.add("DataGrid.js");
jsFiles.add("OfficePicker.js");
jsFiles.add("DepartmentPicker.js");
...
request.setAttribute("initializer", "initWorkInProgressReport");
