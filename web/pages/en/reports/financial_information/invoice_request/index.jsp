...
pageProperties.put("title", "Invoice Request Report");
pageProperties.put("description", "Page is used to build Invoicing Request Report");
pageProperties.put("keywords", "Timesheet, employee, time, tasks, projects");

List<String> jsFiles = new LinkedList<String>();
jsFiles.add("InvoiceRequestReport.js");
jsFiles.add("main.js");
...
request.setAttribute("initializer", "initInvoiceRequestReport");
