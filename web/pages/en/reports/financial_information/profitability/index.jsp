...
pageProperties.put("title", "Profitability Report");
pageProperties.put("description", "Page is used to build Profitability Report");
pageProperties.put("keywords", "Timesheet, employee, time, tasks, projects");

List<String> jsFiles = new LinkedList<String>();
jsFiles.add("ProfitabilityReport.js");
jsFiles.add("main.js");
...
request.setAttribute("initializer", "initProfitabilityReport");
