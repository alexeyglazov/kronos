...
pageProperties.put("title", "Margin Report");
pageProperties.put("description", "Page is used to build Margin Report");
pageProperties.put("keywords", "Timesheet, employee, time, tasks, projects");

List<String> jsFiles = new LinkedList<String>();
jsFiles.add("MarginReport.js");
jsFiles.add("main.js");
...
request.setAttribute("initializer", "initMarginReport");
