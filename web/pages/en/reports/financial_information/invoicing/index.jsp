...
pageProperties.put("title", "Invoicing Report");
pageProperties.put("description", "Page is used to build Invoicing Report");
pageProperties.put("keywords", "Timesheet, employee, time, tasks, projects");

List<String> jsFiles = new LinkedList<String>();
jsFiles.add("InvoicingReport.js");
jsFiles.add("main.js");
...
request.setAttribute("initializer", "initInvoicingReport");
