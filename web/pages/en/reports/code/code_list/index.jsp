...
pageProperties.put("title", "Code list report");
pageProperties.put("description", "Page is used to build Code list report");
pageProperties.put("keywords", "Timesheet, employee, time, Code list, projects");

List<String> jsFiles = new LinkedList<String>();
jsFiles.add("CodeListReport.js");
jsFiles.add("main.js");
...
request.setAttribute("initializer", "initCodeListReport");
