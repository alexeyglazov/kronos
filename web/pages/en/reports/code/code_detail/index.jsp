...
pageProperties.put("title", "Code detail report");
pageProperties.put("description", "Page is used to build Code detail report");
pageProperties.put("keywords", "Timesheet, employee, time, tasks, projects");

List<String> jsFiles = new LinkedList<String>();
jsFiles.add("CodeDetailReport.js");
jsFiles.add("main.js");
...
request.setAttribute("initializer", "initCodeDetailReport");
