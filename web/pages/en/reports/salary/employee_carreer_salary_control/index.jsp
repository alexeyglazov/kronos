...
pageProperties.put("title", "Salary Report");
pageProperties.put("description", "Page is used to build Salary Report");
pageProperties.put("keywords", "Timesheet, employee, time, tasks, projects");

List<String> jsFiles = new LinkedList<String>();
jsFiles.add("SalaryReport.js");
jsFiles.add("main.js");
...
request.setAttribute("initializer", "initSalaryReport");
