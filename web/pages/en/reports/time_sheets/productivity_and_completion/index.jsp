...
pageProperties.put("title", "Productivity and completion report");
pageProperties.put("description", "Page is used to build Productivity and completion reports");
pageProperties.put("keywords", "Timesheet, employee, time, tasks, projects");

List<String> jsFiles = new LinkedList<String>();
jsFiles.add("ProductivityAndCompletionReport.js");
jsFiles.add("main.js");
...
request.setAttribute("initializer", "initProductivityAndCompletionReport");
