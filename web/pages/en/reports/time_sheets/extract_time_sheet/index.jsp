...
pageProperties.put("title", "Timesheet report");
pageProperties.put("description", "Page is used to build Timesheet report");
pageProperties.put("keywords", "Timesheet, employee, time, tasks, projects");

List<String> jsFiles = new LinkedList<String>();
jsFiles.add("TimeSheetReport.js");
jsFiles.add("main.js");
...
request.setAttribute("initializer", "initTimeSheetReport");
