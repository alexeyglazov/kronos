...
pageProperties.put("title", "Own time report");
pageProperties.put("description", "Page is used to build Own time report");
pageProperties.put("keywords", "Timesheet, employee, time, tasks, projects");

List<String> jsFiles = new LinkedList<String>();
jsFiles.add("OwnTimeReport.js");
jsFiles.add("main.js");
...
request.setAttribute("initializer", "initOwnTimeReport");
