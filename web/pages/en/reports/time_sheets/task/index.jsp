...
pageProperties.put("title", "Task report");
pageProperties.put("description", "Page is used to build Task reports");
pageProperties.put("keywords", "Timesheet, employee, time, tasks, projects");

List<String> jsFiles = new LinkedList<String>();
jsFiles.add("TaskReport.js");
jsFiles.add("main.js");
...
request.setAttribute("initializer", "initTaskReport");
