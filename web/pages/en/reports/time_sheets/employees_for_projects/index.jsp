...
pageProperties.put("title", "Employees For Projects Report");
pageProperties.put("description", "Page is used to build Employees For Projects Report");
pageProperties.put("keywords", "Timesheet, employee, time, tasks, projects");

List<String> jsFiles = new LinkedList<String>();
jsFiles.add("EmployeesForProjectsReport.js");
jsFiles.add("main.js");
...
request.setAttribute("initializer", "initEmployeesForProjectsReport");
