...
pageProperties.put("title", "Actual timespent report");
pageProperties.put("description", "Page is used to build Actual timespent reports");
pageProperties.put("keywords", "Timesheet, employee, time, tasks, projects");

List<String> jsFiles = new LinkedList<String>();
jsFiles.add("ActualTimespentReport.js");
jsFiles.add("main.js");
...
request.setAttribute("initializer", "initActualTimespentReport");
