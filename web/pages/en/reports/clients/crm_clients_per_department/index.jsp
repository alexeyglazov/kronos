...
pageProperties.put("title", "CRM Client Per Department Report");
pageProperties.put("description", "Page is used to build CRM Client Per Department Report");
pageProperties.put("keywords", "Timesheet, employee, time, tasks, projects");

List<String> jsFiles = new LinkedList<String>();
jsFiles.add("CRMClientPerDepartmentReport.js");
jsFiles.add("main.js");
...
request.setAttribute("initializer", "initCRMClientPerDepartmentReport");
