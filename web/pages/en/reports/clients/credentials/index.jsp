...
pageProperties.put("title", "Credentials report");
pageProperties.put("description", "Page is used to build Credentials report");
pageProperties.put("keywords", "Timesheet, employee, time, tasks, projects");

List<String> jsFiles = new LinkedList<String>();
jsFiles.add("CredentialsReport.js");
jsFiles.add("main.js");
...
request.setAttribute("initializer", "initCredentialsReport");
