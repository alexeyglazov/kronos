...
pageProperties.put("title", "CRM Clients");
pageProperties.put("description", "Page is used to build CRM Clients reports");
pageProperties.put("keywords", "Timesheet, employee, time, tasks, projects");

List<String> jsFiles = new LinkedList<String>();
jsFiles.add("CRMClientReport.js");
jsFiles.add("main.js");
...
request.setAttribute("initializer", "initCRMClientReport");
