...
pageProperties.put("title", "Profile management");
pageProperties.put("description", "Page is used for profile management");
pageProperties.put("keywords", "Timesheet, employee, time, tasks, projects");

List<String> jsFiles = new LinkedList<String>();
jsFiles.add("main.js");
jsFiles.add("RightsManager.js");
jsFiles.add("EmployeeRightsForm.js");
...
request.setAttribute("initializer", "initRights");
