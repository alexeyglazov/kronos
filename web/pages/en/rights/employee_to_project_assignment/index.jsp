...
pageProperties.put("title", "Employee to Project assignment");
pageProperties.put("description", "Page is used to assign employees to projects");
pageProperties.put("keywords", "Project, code, employee");

List<String> jsFiles = new LinkedList<String>();
jsFiles.add("main.js");
jsFiles.add("EmployeeToProjectAssignmentManager.js");
jsFiles.add("DataGrid.js");
jsFiles.add("EmployeeProjectCodeAccessItemEditForm.js");
...
request.setAttribute("initializer", "initEmployeeToProjectAssignmentManager");
