...
pageProperties.put("title", "Employee planning viewer");
pageProperties.put("description", "Page is used to view planning resources");
pageProperties.put("keywords", "Planning tool");

List<String> jsFiles = new LinkedList<String>();
jsFiles.add("main.js");
jsFiles.add("DataGrid.js");
jsFiles.add("EmployeePlanningViewer.js");
...
request.setAttribute("initializer", "initEmployeePlanningViewer");
