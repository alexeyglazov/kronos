...
bodies.put("main", "/bodies/en/planning_tool/index.jsp");

Map<String, String> pageProperties = new HashMap<String, String>();
pageProperties.put("title", "Planning tool");
pageProperties.put("description", "Page is used to work with planning");
pageProperties.put("keywords", "Planning");
