...
bodies.put("main", "/bodies/en/clients/index.jsp");

Map<String, String> pageProperties = new HashMap<String, String>();
pageProperties.put("title", "Client");
pageProperties.put("description", "Page is used to work with clients");
pageProperties.put("keywords", "Client, contact, person in charge, projects");
