...
pageProperties.put("title", "Mailer");
pageProperties.put("description", "Page is used to make mailouts");
pageProperties.put("keywords", "Mail, template, contact");

List<String> jsFiles = new LinkedList<String>();
jsFiles.add("main.js");
jsFiles.add("MailoutManager.js");
...
jsFiles.add("MailoutEditForm.js");
jsFiles.add("MailoutContentEditForm.js");
jsFiles.add("MailoutTemplateEditForm.js");
...
request.setAttribute("initializer", "initMailoutManager");
