...
pageProperties.put("title", "Code");
pageProperties.put("description", "Page is used for Code creation");
pageProperties.put("keywords", "Timesheet, employee, time, tasks, projects");

List<String> jsFiles = new LinkedList<String>();
jsFiles.add("main.js");
jsFiles.add("ProjectCodeForm.js");
...
request.setAttribute("initializer", "initProjectCodeForm");
