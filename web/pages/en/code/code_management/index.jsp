...
pageProperties.put("title", "Code Management");
pageProperties.put("description", "Page is used for Code Management");
pageProperties.put("keywords", "Timesheet, employee, time, tasks, projects");

List<String> jsFiles = new LinkedList<String>();
jsFiles.add("main.js");
jsFiles.add("ProjectCodesList.js");
...
jsFiles.add("ProjectCodeBatchEditForm.js");
...
request.setAttribute("initializer", "initProjectCodesList");
