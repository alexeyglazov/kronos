...
pageProperties.put("title", "Close Month");
pageProperties.put("description", "Page is used to close months");
...
request.setAttribute("initializer", "initMonthCloser");
