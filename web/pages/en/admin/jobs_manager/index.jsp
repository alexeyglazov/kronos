...
pageProperties.put("title", "Jobs Manager");
pageProperties.put("description", "Page is used to manage jobs");
pageProperties.put("keywords", "Jobs");

List<String> jsFiles = new LinkedList<String>();
jsFiles.add("main.js");
jsFiles.add("DataGrid.js");
jsFiles.add("JobsManager.js");
...
request.setAttribute("initializer", "initJobsManager");
