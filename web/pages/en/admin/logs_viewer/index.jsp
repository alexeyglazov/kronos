...
pageProperties.put("title", "Logs viewer");
pageProperties.put("description", "Page is used to view logs");
pageProperties.put("keywords", "Logs");

List<String> jsFiles = new LinkedList<String>();
jsFiles.add("main.js");
jsFiles.add("DataGrid.js");
jsFiles.add("LogsViewer.js");
...
request.setAttribute("initializer", "initLogsViewer");
