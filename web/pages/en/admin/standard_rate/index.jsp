...
pageProperties.put("title", "Standard Rates");
pageProperties.put("description", "Page is used for Standard Rates management");
pageProperties.put("keywords", "Timesheet, employee, time, tasks, projects");

List<String> jsFiles = new LinkedList<String>();
jsFiles.add("main.js");
jsFiles.add("StandardRatesManager.js");
jsFiles.add("StandardSellingRatesEditForm.js");
jsFiles.add("StandardCostsEditForm.js");
...
request.setAttribute("initializer", "initStandardRatesManager");
