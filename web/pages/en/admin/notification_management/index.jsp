...
pageProperties.put("title", "Notification Management");
pageProperties.put("description", "Page is used for Notification Management");
pageProperties.put("keywords", "Timesheet, employee, time, tasks, projects");

List<String> jsFiles = new LinkedList<String>();
jsFiles.add("main.js");
jsFiles.add("NotificationManagement.js");
...
request.setAttribute("initializer", "initNotificationManagement");
