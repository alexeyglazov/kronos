...
pageProperties.put("title", "Monthly TimeSheet Report");
pageProperties.put("description", "Page is used to build Monthly TimeSheet Report");
pageProperties.put("keywords", "Timesheet, employee, time, tasks, projects");

List<String> jsFiles = new LinkedList<String>();
jsFiles.add("MonthlyTimeSheetReport.js");
jsFiles.add("main.js");
...
request.setAttribute("initializer", "initMonthlyTimeSheetReport");
