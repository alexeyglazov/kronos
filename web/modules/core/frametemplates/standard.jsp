...
<table id="header">
<tr><td>    
<% String topMenuElement = moduleBaseUrl + "elements/top_menu.jsp"; %>
<jsp:include page="<%=topMenuElement %>" flush="true" />
...
<% String leftMenuElement = moduleBaseUrl + "elements/left_menu.jsp"; %>
<jsp:include page="<%=leftMenuElement %>" flush="true" />
</td>
