...
if("generateReport".equals(command)) {
    ...
    InvoiceRequestReport invoiceRequestReport = new InvoiceRequestReport(filter, invoiceRequestsFilter, module, currentUser);
    invoiceRequestReport.build();
    InvoiceRequestReportVO invoiceRequestReportVO = new InvoiceRequestReportVO(invoiceRequestReport);
    %>
    {
    "status": "OK",
    "invoiceRequestReport": <% gson.toJson(invoiceRequestReportVO, out); %>
    }
    <%
    ...
    String fileName = "InvoiceRequest_";
    fileName += dateFormatterLong.format(invoiceRequestReport.getCreatedAt());
    fileName += ".xls";

    response.setContentType("application/vnd.ms-excel");
    response.setHeader("content-disposition", "filename=" + fileName);
    InvoiceRequestReportExcelBuilder reb = new InvoiceRequestReportExcelBuilder(invoiceRequestReport);
