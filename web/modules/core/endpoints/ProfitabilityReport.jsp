...
<%
    ...
    //byte[] q = bos.toByteArray();
    //out.print(q);
} else if("runBackgroundProcess".equals(command)) {
    ProfitabilityReportForm profitabilityReportForm = ProfitabilityReportForm.getFromJson(request.getParameter("profitabilityReportForm"));
    ProfitabilityReportJob job = new ProfitabilityReportJob();
    job.setName("Profitability report");
    job.setPart(0.0);
    job.setStartDate(new Date());
    job.setEmployee(currentUser);
    job.setProfitabilityReportForm(profitabilityReportForm);
